...
export default function TeacherCard({
  ...
  return (
    <div className="w-full max-w-xs bg-white rounded-xl shadow-lg transform transition duration-300 hover:scale-105 hover:shadow-2xl">
      ...
      <div className="p-4 text-center">
        <h3 className="text-xl font-bold text-blue-800 mb-1">{name}</h3>
        <p className="text-sm font-medium text-blue-600 mb-1">{subject}</p>
        <p className="text-sm italic text-gray-700 mb-2">{experience}</p>
